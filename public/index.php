...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="css/landing.css?v=4.2">
            ...
            <div class="text-center mb-5">
                ...
                <div id="annualPromoInfo" class="d-none mt-3">
                    <div class="d-inline-flex flex-wrap justify-content-center gap-2">
                        <span class="badge rounded-pill px-3 py-2" style="background:rgba(var(--bs-primary-rgb),0.1);color:var(--mc-primary);border:1px solid rgba(var(--bs-primary-rgb),0.3);font-size:0.8rem">
            ...
            <div class="row g-4">
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 border h-100">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3 p-2 rounded-3"><div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0" style="width:40px;height:40px;background:rgba(var(--bs-primary-rgb),0.1);color:var(--mc-primary)"><i class="ph-bold ph-envelope-simple"></i></div><div><strong class="d-block small">Email Support</strong><small class="text-muted">support@mekongcyberunit.app</small></div></div>
                        <div class="d-flex align-items-center gap-3 mb-3 p-2 rounded-3"><div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0" style="width:40px;height:40px;background:rgba(var(--bs-primary-rgb),0.1);color:var(--mc-primary)"><i class="ph-bold ph-telegram-logo"></i></div><div><strong class="d-block small">Telegram</strong><small class="text-muted"><a href="https://t.me/SOCHEAT_DOEM" target="_blank" rel="noopener" style="color:var(--mc-primary);font-weight:600">@SOCHEAT_DOEM</a></small></div></div>
                        <div class="d-flex align-items-center gap-3 p-2 rounded-3"><div class="rounded-3 d-flex align-items-center justify-content-center flex-shrink-0" style="width:40px;height:40px;background:rgba(var(--bs-primary-rgb),0.1);color:var(--mc-primary)"><i class="ph-bold ph-map-pin"></i></div><div><strong class="d-block small">Headquarters</strong><small class="text-muted">Sensok District, Phnom Penh, Cambodia</small></div></div>
                    </div>
                </div>
                <div class="col-lg-7">
