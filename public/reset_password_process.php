...
$resetUrl = "$urlPrefix/reset_password.php?token=" . urlencode($token);
...
try {
    ...
    header("Location: $urlPrefix/forgot_password.php?error=" . urlencode('Reset link is invalid or expired. Please request a new link.'));
    exit;
} catch (Exception $e) {
