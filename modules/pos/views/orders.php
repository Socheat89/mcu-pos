...
<<<<<<< HEAD
        <div class="pos-page-hero">
            <div style="position: relative; z-index: 2;">
                ...
                <h1 class="pos-page-hero__title" style="margin-top: 14px;"><?php echo __('transaction_history'); ?></h1>
                <p class="pos-page-hero__text"><?php echo __('orders_management_msg'); ?></p>
                <div class="pos-page-hero__actions">
                    <a href="<?php echo htmlspecialchars($posUrl('pos')); ?>" class="btn btn-primary" style="padding: 14px 22px; border-radius: 18px;">
